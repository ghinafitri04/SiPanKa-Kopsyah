        ...
        <div class="container mt-5">
            ...
            <div class="berita-acara-container mt-5">
                 <div class="berita-acara-title-box">
                        ...
                        <div>
                            <input type="text" id="adminName" name="adminName" class="inputnamanotaris">
                        </div>     
                         ...
                         <div class="berita-acara-content-box">
                            ...
                            <!-- Tambahkan ikon upload di sini -->
                                    ...
                                    <input type="file" id="file-upload" />
                                     <img src="/img/uploadgambar.png" alt="Your Image" class="centered-image">
                                     <p class="image-caption">Upload Gambar</p>
